...
from backend.domain.errors import StorageError, FileStorageError
...
class FileMovieRepository(IMovieRepository):
    ...
    def get_latest_snapshot(self) -> Optional[ScrapeResult]:
    ...
    def get_snapshot_by_date(self, date: str) -> Optional[ScrapeResult]:
    ...
    def _load_file(self, file_path: Path) -> Optional[ScrapeResult]:
