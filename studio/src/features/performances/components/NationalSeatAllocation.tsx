    ...
    <Card className="mb-6 overflow-hidden border-border/50">
      <CardHeader className="pb-4 border-b bg-muted/5 py-2.5">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="hidden xl:flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-muted-foreground/60">
      ...
      <CardContent className="p-0">
        <div className="grid grid-cols-1 xl:grid-cols-2 divide-y xl:divide-y-0">
          ...
          <div className="w-full flex flex-col gap-2 p-6 bg-background/50 xl:border-r">
            <div className="flex items-center justify-between text-sm font-black uppercase tracking-tighter text-muted-foreground mb-1">
            ...
            <div className="mt-4 space-y-1">
              <div className="flex items-center gap-2">
                <span className="text-sm font-bold text-muted-foreground font-mono w-4">0%</span>
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div className="relative h-4 w-full">
                    ...
                    <div className="absolute left-[33.33%] -translate-x-1/2 flex flex-col items-center">
                        ...
                        <span className="text-sm font-bold font-mono text-muted-foreground/60">10%</span>
                    </div>
                    {/* Tick Mark 20% */}
                    <div className="absolute left-[66.66%] -translate-x-1/2 flex flex-col items-center">
                        <div className="w-px h-1 bg-muted-foreground/30 mb-0.5" />
                        <span className="text-sm font-bold font-mono text-muted-foreground/60">20%</span>
                    </div>
                  </div>
                </div>
                <span className="text-sm font-bold text-muted-foreground font-mono w-6">30%+</span>
              </div>
              
              <div className="flex justify-between text-sm font-black uppercase tracking-widest text-muted-foreground/40 pt-1">
