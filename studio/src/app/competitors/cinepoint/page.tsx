      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground uppercase tracking-widest font-bold opacity-60">Movie Database Sync</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Link href="/competitors/cinepoint/analysis">
            <Button variant="outline" size="sm" className="h-8 gap-2 px-4 text-sm font-black uppercase tracking-wider rounded-xl border-border/60 hover:bg-muted transition-all">
        ...
        <div className="p-4 rounded-2xl border border-border/40 bg-card shadow-sm space-y-3">
          ...
          {gatePending && (
            <div className="p-3 rounded-xl bg-amber-500/5 border border-amber-500/20 flex items-center justify-between">
              <span className="text-sm font-bold text-amber-600">⏸ 3 pages validated. Ready to continue full backfill?</span>
              <div className="flex gap-2">
