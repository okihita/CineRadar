...
import { useBoxOfficeData, RANGE_PRESETS } from './useBoxOfficeData';
import { MovieDrillDown } from './MovieDrillDown';
import { FullRankings } from './FullRankings';

export interface InsightsTabProps {
  boxOffice: ReturnType<typeof useBoxOfficeData>;
}

export function InsightsTab({ boxOffice }: InsightsTabProps) {
  const {
