...
const FIRESTORE_TARGETS = [
    ...
    },
    {
        ...
        description: 'Chronological raw promotional posts from XXI, CGV, and Cinepolis.',
        supportsDate: false,
        supportsMovieId: false,
    },
    {
...
export function RawTelemetryTab() {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h3 className="text-lg font-bold text-foreground">Firestore Document Inspector</h3>
                    <p className="text-sm text-muted-foreground">
                        Direct inspection tool for Firestore collections: daily pulse snapshots, movie subcollections, and exhibitor timelines.
                    </p>
                </div>
