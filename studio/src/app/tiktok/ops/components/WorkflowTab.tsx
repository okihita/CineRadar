    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/60 pb-4">
                <div>
                    <h3 className="text-lg font-bold text-foreground">Pipeline Architecture &amp; Execution Topology</h3>
                    <p className="text-muted-foreground text-sm font-medium">
                        Interactive end-to-end data flow: automated crawling, Gen 2 functions, Gemini NLP enrichment, and Firestore synthesis.
                    </p>
                </div>
