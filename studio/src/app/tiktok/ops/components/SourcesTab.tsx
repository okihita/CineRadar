...
export function SourcesTab() {
    ...
    return (
        <div className="space-y-6">
            {/* Header */}
            <div>
                <h3 className="text-lg font-bold text-foreground">Authoritative Truth Seeds &amp; Hashtag Rules</h3>
                <p className="text-sm text-muted-foreground">
                    Manage authoritative truth seed accounts, manual movie hashtag overrides, and excluded noise tags for automated discovery.
                </p>
            </div>
