    ...
    return (
        <div className="min-h-screen bg-background text-foreground p-6 max-w-[1400px] mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border/60 pb-6">
                ...
                <Badge variant="outline" className="px-3 py-1 text-xs font-semibold gap-1.5 self-start md:self-auto bg-emerald-500/5 text-emerald-600 dark:text-emerald-400 border-emerald-500/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <Card className="lg:col-span-2 border-border/60 bg-card">
                    ...
                    <CardContent className="p-6 space-y-5">
                        ...
                        <div className="flex items-center justify-between p-3.5 rounded-xl bg-muted/30 border border-border/40 text-xs">
                        ...
                        <div>
                            ...
                            <div className="p-3 rounded-xl bg-zinc-950 text-zinc-300 font-mono text-xs overflow-x-auto border border-border/40">
                                <code>
                    ...
                    <CardContent className="p-5 pt-0 space-y-3 text-xs">
                        <div className="p-3 rounded-xl bg-muted/30 border border-border/30 space-y-1">
                            <div className="flex items-center justify-between font-bold">
                                ...
                                <Badge variant="outline" className="text-[10px]">11:00 WIB</Badge>
                            </div>
                        ...
                        <div className="p-3 rounded-xl bg-muted/30 border border-border/30 space-y-1">
                            <div className="flex items-center justify-between font-bold">
                                ...
                                <Badge variant="outline" className="text-[10px]">23:00 WIB</Badge>
                            </div>
                            <p className="text-muted-foreground text-[11px]">
                    ...
                    <div className="divide-y divide-border/30 text-xs">
                        {RECENT_JOBS.map((job) => (
                            <div key={job.id} className="p-4 flex items-center justify-between gap-4 hover:bg-muted/20 transition-colors">
                                ...
                                <Link
                                    href="/tiktok/explorer"
                                    className="px-3 py-1.5 rounded-lg bg-muted/50 hover:bg-muted font-medium text-[11px] flex items-center gap-1 text-foreground transition-colors"
                                >
                                    Explorer
