                                ...
                                {availableChains.map(chain => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 text-xs font-bold rounded-lg border transition-all duration-200 cursor-pointer flex-shrink-0 active:scale-95 ${
                                                isEnabled
