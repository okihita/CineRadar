                    ...
                    <CardContent className="pt-0">
                        <div className="space-y-3">
                            {data.hotMovies.map((movie, i) => (
                                <div key={`${movie.title}-${i}`} className="flex items-center gap-3">
                        ...
                        <div className="h-[200px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={data.topTheatres} layout="vertical" margin={{ left: 0, right: 10 }}>
                                    ...
                                    />
                                    <Tooltip formatter={(v: number | string | readonly (number | string)[] | undefined) => typeof v === 'number' || typeof v === 'string' ? [formatRupiah(Number(v)), 'Revenue'] : ['', '']} />
