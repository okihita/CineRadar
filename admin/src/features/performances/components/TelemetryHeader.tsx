    ...
    return (
        <div className="flex flex-col items-end justify-center px-6 py-3">
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col items-end">
                    <div className="flex items-center gap-1.5">
                        {status === 'crunching' ? (
                            <>
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-amber-600/80">Crunching</span>
                            </>
                        ) : (
                            <>
                                <Zap className="w-3 h-3 text-primary fill-primary/20" />
                                <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Verified</span>
                            </>
                        )}
                    </div>
                    <div className="flex items-baseline gap-1">
                        ...
                        <span className="text-[8px] font-bold opacity-40 uppercase">sec</span>
                    </div>
                </div>
                ...
                {status === 'completed' && payloadSize && (
                    <div className="flex flex-col items-end border-l border-border/30 pl-3">
                        <div className="flex items-center gap-1 text-muted-foreground/60">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-widest">Payload</span>
                        </div>
                        <div className="flex items-baseline gap-1">
                            <span className="text-lg font-black font-mono tracking-tighter leading-none">
                                {payloadSize.toFixed(1)}
                            </span>
                            <span className="text-[8px] font-bold opacity-40 uppercase">kB</span>
                        </div>
                    </div>
                )}
            </div>
            ...
            <div className="mt-1 flex items-center gap-1">
                ...
                <span className="text-[7px] font-black uppercase tracking-tighter text-muted-foreground/40">
